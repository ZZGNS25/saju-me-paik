...
import { Atmosphere } from '../components/layout'
import { ResultPanel } from '../components/result'
import { useShareNote } from '../hooks/useShareNote'
import { formatBirthDateLabel, formatBirthTime } from '../lib/date'
import { resultParagraphs } from '../lib/resultText'
      ...
      <main className="shell result-shell">
        ...
        {loading ? (
          ...
          <ResultPanel
            ...
            visibleParagraphs={resultParagraphs(reading.result)}
            paragraphKey="shared"
            onShare={handleShareAgain}
            shareNote={shareNote}
            shareLabel="친구에게 다시 공유"
          >
            <Link className="cta-new" to="/">
              내 사주도 보러 가기
            </Link>
